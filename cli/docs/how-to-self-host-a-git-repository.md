...
After pushing, git will run github-ai-genius and generate files under `~/public/repo/` directory.

- Private read-write clone URL: `git@example.com:public/repo.git`
- Public **read-only** clone URL: `http://example.com/repo.git`
- GitHub AI Genius static web view: `http://example.com/repo/`
